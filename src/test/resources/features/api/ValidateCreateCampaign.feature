Feature: Verify Create Campaign
  ...
  Scenario: Validate that user should be able to create campaign
    ...
    When user set parameter to create campaign with following details
...
#  Scenario: Validate that user should be able to create campaign
#    Given user set parameter to create an advetiser with name as "true:" and state as "true:active"
#    When user post a POST request to create an advetiser
#    Then validate that response of create advertiser API should have status code as 200
#    Given user set parameter to create campaign with name as "true:", budget_type as "true:impression", budget_type_value as "true:50000", start_date as today plus "true:0" days, end_date as today plus "true:10" days, advertiser as "true:" and provider as "true:iab"
#    When user post a POST request to create campaign
#    Then validate that response of create campaign API should have status code as 200
#    Given user set parameter to create line item with name as "true:", cpm as "true:5", margin as "true:10" and ad_type as "true:video"
#    When user post a POST request to create line item
#    Then validate that response of create line item API should have status code as 200
#    Given user set parameter to create targeting with city as "true:", country as "true:", region as "true:", dma as "true:", language as "true:", device_type as "true:", os_type as"true:", browser as "true:", segment as "true:", seller_network as "true:", player_size as "true:", visibility_type as"true:", daypart_target as "true:", inventory_list as "true:" and zip_code_file as "false:"
#    #Given user set parameter to create targeting with city as "false:", country as "true:", region as "false:", dma as "false:", language as "false:", device_type as "false:", os_type as"false:", browser as "false:", segment as "false:", seller_network as "false:", player_size as "false:", visibility_type as"false:", daypart_target as "false:", inventory_list as "false:" and zip_code_file as "false:"
#    When user post a POST request to create targeting
#    Then validate that response of create targeting API should have status code as 200
#    Given user set parameter to create ad unit with name as "true:", budget interval start_date as today plus "true:0" days, end_date as today plus "true:4" days and impression or revenue as "true:10000"
#    When user post a POST request to create ad unit
#    Then validate that response of create ad unit API should have status code as 200
#    Given user set parameter to create Creative with name as "true:", advertiser_id as "true:", ad_type as "true:", is_third_party_tag as "true:false", ad_tag_type as "true:vpaid" and is_non_linear as "true:true"
#    When user post a POST request to create Creative
#    Then validate that response of create Creative API should have status code as 200
#    Given user set parameter to create Creative Media with media_url as "true:", file_type as "true:", width as "true:", height as "true:" and duration as "true:"
#    When user post a POST request to create Creative Media
#    Then validate that response of create Creative Media API should have status code as 200
#    Given user set parameter to create AdTag
#    When user post a PUT request to create AdTag
...
#    Then validate that response of publish campaign API should have status code as 200
#
#  Scenario: Validate creative
#
#    Given user set parameter to create Creative with name as "true:", advertiser_id as "true:", ad_type as "true:", is_third_party_tag as "true:true", ad_tag_type as "true:vpaid" and is_non_linear as "true:true"
#    When user post a POST request to create Creative
#    Then validate that response of create Creative API should have status code as 200
